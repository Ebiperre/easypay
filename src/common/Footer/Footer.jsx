      ...
      <div className="flex items-baseline justify-between mb-20">
        ...
        <div className="">
          ...
          <div className="grid grid-cols-2">
            <p className="p-1 cursor-pointer">About Us</p>
            <p className="p-1 cursor-pointer">Privacy Policy</p>
            <p className="p-1 cursor-pointer">Help</p>
            <p className="p-1 cursor-pointer">Terms and Condition</p>
            <p className="p-1 cursor-pointer">Join Us</p>
            <p className="p-1 cursor-pointer">Security</p>
            <p className="p-1 cursor-pointer">FAQs</p>
          </div>
        </div>
